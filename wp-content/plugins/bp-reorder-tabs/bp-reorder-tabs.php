...
if (!defined( 'BUDDYBOSS_REORDER_TABS_PLUGIN_VERSION' ) ) {
  define( 'BUDDYBOSS_REORDER_TABS_PLUGIN_VERSION', '1' );
}
...
if ( !function_exists( 'register_buddyboss_menu_page' ) ) {
	...
	function register_buddyboss_menu_page() {
		...
		add_menu_page( 'BuddyBoss', 'BuddyBoss', 'manage_options', 'buddyboss-settings', '', BUDDYBOSS_REORDER_TABS_PLUGIN_URL . 'assets/images/logo.svg', 61.000129 );
