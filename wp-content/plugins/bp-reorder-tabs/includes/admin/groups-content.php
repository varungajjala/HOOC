				...
				<td>
					<select name="def_profile_page" id="def_profile_page">
						...
						if( !empty( $groups_nav ) ){
							...
							*/
							$public_navs = apply_filters( 'bp_r_t_group_default_options', array( 'home', 'members' ) );
					...
					<p class="description"><?php _e( 'Only public pages can be set as default.', 'bp-reorder-tabs' );?></p>
				</td>
			</tr>
		</tbody>
	</table>
